...
```
# Site settings
title: YuanLe Blog                    # 你的博客网站标题
SEOTitle: 元乐的博客 | YuanLe Blog		# SEO 标题
description: "Hey"	   	   # 随便说点，描述一下

# SNS settings      
github_username: itx-man     # 你的github账号
jianshu_username: ef9e299d3ce9  # 你的简书ID。
...
sidebar-avatar: /img/facebook.jpg     #你的大头贴，请使用绝对地址.注意：名字区分大小写！后缀名也是
```
...
在下面输入的社交账号，没有的添加的不会显示在侧边框中。新加入了[简书](https:/www.jianshu.com)链接, <http://www.jianshu.com/u/ef9e299d3ce9>
...
```
# Baidu Analytics
ba_track_id: b2753c72fdde159150ac68e38ba30d9b

# Google Analytics
ga_track_id: 'UA-125439496-1'            # 你用Google账号去注册一个就会给你一个这样的id
...
我的博客标题是 **“YuanLe Blog”** 但是我想要在搜索的时候显示 **“元乐的博客 | YuanLe Blog”** ，这个就需要 SEO Title 来定义了。
